        ...
        <div class="login_box">
            ...
            <el-form class="login_form" :model="form" :rules="rules" ref="loginFormRef">
                ...
                <el-form-item prop="username">
                    <el-input placeholder="请输入账号" v-model="form.username" prefix-icon="iconfont icon-user"></el-input>
                </el-form-item>
                <!-- 密码 -->
                <el-form-item prop="password">
                    <el-input placeholder="请输入密码" type="password" v-model="form.password" prefix-icon="iconfont icon-password"></el-input>
                </el-form-item>
                <!-- 按钮 -->
